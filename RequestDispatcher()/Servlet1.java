...
public class AddServletClass extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		req.setAttribute("ans", k); // getting some data in req object as it is being forwarded to another servlet
		
		RequestDispatcher rd = req.getRequestDispatcher("sq");
		rd.forward(req, res); //both the instances being forwarded to another servlet for calculating the square of sum
	}
